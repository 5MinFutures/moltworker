...
debug.get('/env', async (c) => {
  return c.json({
    ...
    has_elevenlabs_key: !!c.env.ELEVENLABS_API_KEY,
    has_elevenlabs_voice_id: !!c.env.ELEVENLABS_VOICE_ID,
    elevenlabs_key_type: typeof c.env.ELEVENLABS_API_KEY,
    elevenlabs_key_length: c.env.ELEVENLABS_API_KEY?.length || 0,
